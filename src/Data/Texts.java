...
public class Texts {
    ...
    public static final String ENTER_KEY = "Введите ключ шифрования (целое число больше 0):";
    ...
    //validator
    public static final String KEY_IS_NAN = "Ошибка ввода! Нужно ввести целое число больше 0";
    public static final String KEY_IS_ZERO = "Не подойдет! Число должно быть больше 0 и не кратно " + Alphabet.alphabetSmallRusLength + " иначе ничего не произойдет";
